...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1676&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-stapler-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-stapler` can be installed with `conda`:
...
```
mamba install r-stapler
```

It is possible to list all of the versions of `r-stapler` available on your platform with `conda`:
...
```
mamba search r-stapler --channel conda-forge
```
...
mamba repoquery search r-stapler --channel conda-forge

# List packages depending on `r-stapler`:
mamba repoquery whoneeds r-stapler --channel conda-forge

# List dependencies of `r-stapler`:
mamba repoquery depends r-stapler --channel conda-forge
```
